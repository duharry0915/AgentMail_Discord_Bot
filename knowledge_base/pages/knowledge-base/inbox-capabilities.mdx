...
- **Send emails** to any email address on the internet
- **CC and BCC** to include humans in the loop or copy other agents
- **HTML and plain text** for rich formatted emails
- **Attachments** with Base64 encoding (PDFs, images, documents)
- **Custom display names** like "Support Agent" instead of a raw email address
- **Labels on send** to tag outgoing messages for campaign tracking or workflow state
- **Drafts** to compose emails for human review before sending
...
- **Org-wide thread listing** to query conversations across all inboxes in your organization
